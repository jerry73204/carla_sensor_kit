...
def generate_launch_description():
    ...
    auto_unique_name_arg = DeclareLaunchArgument(
        "auto_unique_name",
        default_value="False",
        description="Automatically append number to role_name if it already exists",
    )
        ...
        parameters=[
            {
                ...
                "auto_unique_name": LaunchConfiguration("auto_unique_name"),
            }
        ],
    )
