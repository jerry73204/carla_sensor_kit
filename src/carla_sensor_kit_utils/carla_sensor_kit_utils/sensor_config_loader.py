...
class SensorConfigLoader:
    ...
    def __init__(self, sensor_kit_path: Optional[str] = None):
        ...
        if sensor_kit_path is None:
            ...
            possible_paths = [
                ...
                Path(
                    "/home/aeon/repos/carla_sensor_kit_launch/carla_sensor_kit_description"
                ),
            ]
            ...
            if sensor_kit_path is None:
                raise RuntimeError(
                    "Could not find carla_sensor_kit_description package"
                )
    ...
    def get_sensor_transform(
        self, sensor_name: str, relative_to_vehicle: bool = True
    ) -> carla.Transform:
        """
        ...
        kit_to_sensor = self.sensor_kit_calibration["sensor_kit_base_link"].get(
            sensor_name
        )
    ...
    def get_camera_transform(
        self, camera_type: str = "traffic_light_left"
    ) -> carla.Transform:
